Events.SequenceGameInitComplete.Add(function()
    ...
    function ReloadFix()
        ...
        if(playersWaiting == 0) then
            ...
            if currentTurn > g_LastSaveTurn then
                print("HB Save Turn - " .. currentTurn);
    
                local turnFormat = "Turn_" .. string.format("%03d", currentTurn);
                local saveName = "HBAutoSave_" .. turnFormat;
    
                print("Saveing Game as " .. saveName);
    ...
    function ReloadFixKeyUp(key)

    end
    Events.KeyUpEvent.Add( ReloadFixKeyUp )
    -------------------------------------------------
        ...
        Button = function( control )
            ...
            if player then
                ...
                if player:IsMinorCiv() then
                    ...
                    isShowPortrait = leader and IconHookup( leader.PortraitIndex, g_tipControls.Portrait:GetSizeY(), leader.IconAtlas, g_tipControls.Portrait )
